...
<div>
    <el-container>
        ...
        <el-container class="container2">
            <el-aside style="width: 14%;">
                <el-menu default-active="2-1" background-color="transparent" active-text-color="#00bcd4">
                    <el-submenu index="1">
            ...
            <el-main>
                <el-table :data="showApp.rows">
                    <el-table-column prop="userName" label="用户名" min-width="10vw">
                    ...
                    <el-table-column prop="objectName" :label="openExperts?'学者名':'文献标题'" min-width="10vw">
                        <template slot-scope="scope">
                    ...
                    <el-table-column prop="email" label="联系邮箱" min-width="10vw">
                    </el-table-column>
                    <el-table-column prop="time" label="时间" min-width="10vw">
                    </el-table-column>
                    <el-table-column prop="result" label="状态" min-width="10vw">
                        <template slot-scope="scope">
                            {{scope.row.result===0?'未审核':'已审核'}}
                        </template>
                    </el-table-column>
                    <el-table-column prop="msg" label="审批意见" min-width="20vw">
                    </el-table-column>
                ...
                <div class="block">
                    <el-pagination layout="prev, pager, next" :current-page="showApp.page" @current-change="changePage()" :total="showApp.totalElements">
                    </el-pagination>
                </div>
            </el-main>
        </el-container>
    ...
    <el-dialog title="提示" :visible.sync="dialogVisible" width="30%">
        <el-input placeholder="请输入拒绝原因" v-model="rejectReason" clearable>
        </el-input>
