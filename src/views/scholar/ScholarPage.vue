...
<div class="wrapper">
            ...
            <div id="main-content-left">
                ...
                <div id="achievement">
                    <div class="achievement-pie">
                        <div class="pie_item">
                            <el-progress type="circle" :show-text='false' :percentage="percentage1" :width="100"></el-progress>
                            <p class="pie_title">{{ percentage1 + "%"}}<br />期刊</p>
                        </div>
                        <div class="pie_item">
                            <el-progress type="circle" :show-text='false' :percentage="percentage2" :width="100"></el-progress>
                            <p class="pie_title">{{ percentage2 + "%" }}<br />会议</p>
                        </div>
                        <div class="pie_item">
                            <el-progress type="circle" :show-text='false' :percentage="percentage3" :width="100"></el-progress>
                            <p class="pie_title">{{ percentage3 + "%"}}<br />专著</p>
                        </div>
                        <div class="pie_item">
                            <el-progress type="circle" :show-text='false' :percentage="percentage4" :width="100"></el-progress>
                            <p class="pie_title">{{ percentage4 + "%"}}<br />其他</p>
                        </div>
                        <div class="pie_total">
                        ...
                        <div id="content-top">
                            <div class="content-filter">
                                <div class="filter-item">
                                    <el-popover placement="bottom-start" width="60" trigger="hover">
                                        <!--由后端传具体有哪些年份 for循环-->
                        ...
                        <div id="content-result" v-if="has_result">
                            <div class="result-list">
                                <div v-for="(result_item,index) in result_list" v-bind:key="index">
                                    <academic-item :c_sc=result_item :length=700 v-on:toAuthorPage="searchAuthor" v-on:toSourcePage="searchSource" v-on:quote="showQuote"></academic-item>
                                </div>
                            </div>
                            <div class="result-page" v-show="total_rs > 10">
                                <el-pagination background @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="currentPage" :page-size="10" layout="prev, pager, next, jumper" :total=total_rs class="page">
                                </el-pagination>
                            </div>
                        </div>
                        <!-- 无结果tip -->
    ...
    <!-- 引用 -->
    <el-dialog title="引用" :visible.sync="quotedialogVisible" width="40%">
        <div style="text-align: left">
            <b>以下引用格式为GB/T7714，点击右侧按钮即可复制内容</b>
            <el-button type="warning" size="mini" icon="el-icon-document-copy" style="float: right" v-clipboard:copy="quoteText" v-clipboard:success="copySuccess" v-clipboard:error="copyError"></el-button>
        </div>
        <br />
...
export default {
    ...
    computed: {
        ...
        percentage1() {
            var res = Math.floor((this.paper1_count / this.real_total) * 100);
            console.log(res);
            if (isNaN(res)) {
                return 0;
            }
        ...
        percentage2() {
            var res = Math.floor((this.paper2_count / this.real_total) * 100);
            console.log(res);
            if (isNaN(res)) {
                return 0;
            }
        ...
        percentage3() {
            var res = Math.floor((this.paper3_count / this.real_total) * 100);
            console.log(res);
            if (isNaN(res)) {
                return 0;
            }
        ...
        percentage4() {
            var res = Math.floor(((this.real_total - this.paper1_count - this.paper2_count - this.paper3_count) / this.real_total) * 100);
            console.log(res);
            if (isNaN(res)) {
                return 0;
            }
